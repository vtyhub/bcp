...
public class PP implements Serializable {
	...
	public PP(HashMap<String, String> map) throws NullPointerException {
		BigInteger N = new BigInteger(map.get(BCPForClient.N));
		BigInteger k = new BigInteger(map.get(BCPForClient.k));
		BigInteger g = new BigInteger(map.get(BCPForClient.g));
		this.N = N;
		this.k = k;
		this.g = g;
	}
