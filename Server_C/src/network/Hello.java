...
public class Hello implements NetConstant {
	...
	public static void passivelyHi(ObjectInputStream in, ObjectOutputStream out)
			throws ClassNotFoundException, IOException, ErrorResponseException {
		String hello = (String) in.readObject();
		if (ClIENT_HELLO.equals(hello)) {
			out.writeObject(SERVER_HI);
		} else {
			throw new ErrorResponseException(hello);
		}
	}
